...
export default function BpjsSuccessPage() {
  ...
  useEffect(() => {
    async function fetchBookingInfo() {
      try {
        const res = await fetch('/api/appointments/bpjs/success')
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center">
      <div className="bg-green-100 text-green-800 px-6 py-5 rounded-2xl shadow-md max-w-md">
        ...
        <p className="text-3xl font-bold text-green-700 mb-4">{queue}</p>
